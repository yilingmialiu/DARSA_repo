    ...
    for epoch in range(1, epochs+1):
        ...
        for i in range(len_dataloader):
            ...
            with torch.no_grad():
                ...
                for i in range(len(w_tgt_batch)):
                    if i%2 !=0:
                        w_tgt_batch[i] = w_tgt_batch[i]*0.8
                    if i%2 ==0:
                        w_tgt_batch[i] = w_tgt_batch[i]*1.2
                if epoch ==1:
                    print("after unnorm:",w_tgt_batch)
                w_tgt_batch = w_tgt_batch/w_tgt_batch.sum()
                if epoch ==1:
                    print("after norm:",w_tgt_batch)
