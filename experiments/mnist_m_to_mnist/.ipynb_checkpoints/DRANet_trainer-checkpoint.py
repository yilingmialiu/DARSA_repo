...
def get_dataset(dataset, batch, imsize, workers):
    if dataset == 'G':
        ...
        train_dataset = load_mnist_LS_DRANet(source_num=290,train_flag=True)
        #load_mnist_LS_DRANet(source_num=1800,train_flag=True)
        test_dataset = load_mnist_LS_DRANet(source_num=290,train_flag=True)
