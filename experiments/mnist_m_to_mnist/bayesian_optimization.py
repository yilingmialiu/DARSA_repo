...
def train(
    ...
    model_feature_source.load_state_dict(torch.load(path_to_model+'source_feature_rd_128_SGD.pt'))
    model_feature_target.load_state_dict(torch.load(path_to_model+'source_feature_rd_128_SGD.pt'))
    model_clf.load_state_dict(torch.load(path_to_model+'source_clf_rd_128_SGD.pt'))
