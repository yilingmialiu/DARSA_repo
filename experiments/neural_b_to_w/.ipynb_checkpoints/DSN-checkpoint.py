...
from models.model_DSN_neural import *
...
weight_decay = 1e-6
alpha_weight = 1 #0.01 #1 
beta_weight = 1 #0.075 #1
gamma_weight = 1 #0.25 #1 #0.25
momentum = 0.5 #0.8
...
##########source data########################
dataset_source = my_dataset(X_source, y_source)
dataloader_source = DataLoader(dataset_source, batch_size=batch_size, drop_last=True,\
                           shuffle=True, num_workers=0, pin_memory=True)

##########target data########################
dataset_target = my_dataset(X_target, y_target)
dataloader_target = DataLoader(dataset_target, batch_size=batch_size,drop_last=True,\
                           shuffle=True, num_workers=0, pin_memory=True)
