...
seed_new = 52 #39,52,right now at 62
    ...
    for epoch in range(1, args.epochs+1):
        ...
        with torch.no_grad():
            ...
            if target_accuracy > best_accuracy:
                ...
                torch.save(model_feature.state_dict(), 'trained_models/source_feature_rd_128_SGD_alpha_'+str(args.alpha)+'_v5.pt')
                torch.save(model_classifier.state_dict(), 'trained_models/source_clf_rd_128_SGD_alpha_'+str(args.alpha)+'_v5.pt')
...
if __name__ == '__main__':
    ...
    arg_parser.add_argument('--epochs', type=int, default=30) #30
