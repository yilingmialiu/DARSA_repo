...
def main(args):
    ...
    source_model.load_state_dict(torch.load('trained_models/DANN_source_alpha1.pt'))
    source_model.eval()
    ...
    target_model.load_state_dict(torch.load('trained_models/DANN_source_alpha1.pt'))
