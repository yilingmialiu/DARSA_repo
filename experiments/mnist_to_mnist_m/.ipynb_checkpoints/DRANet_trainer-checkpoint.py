...
def get_dataset(dataset, batch, imsize, workers):
    if dataset == 'G':
        ...
        train_dataset = load_mnist_LS_DRANet(source_num=600,alpha=8,train_flag=True)
        test_dataset = load_mnist_LS_DRANet(source_num=100,alpha=8,train_flag=False)
    
    elif dataset == 'MM':
        train_dataset = load_mnistm_LS_DRANet(target_num=100,alpha=8,MNISTM=MNISTM_DRANet,train_flag=True)
        test_dataset = load_mnistm_LS_DRANet(target_num=100,alpha=8,MNISTM=MNISTM_DRANet,train_flag=False)
