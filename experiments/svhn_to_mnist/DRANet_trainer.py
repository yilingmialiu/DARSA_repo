...
def get_dataset(dataset, batch, imsize, workers):
    if dataset == 'G':
        ...
        train_dataset = load_SVHN_LS_DRANet(target_num=1500,train_flag='train')
        test_dataset = load_SVHN_LS_DRANet(target_num=1500,train_flag='train')
    
    elif dataset == 'M':
        train_dataset = load_mnist_LS_DRANet(source_num=290,train_flag=False)
        test_dataset = load_mnist_LS_DRANet(source_num=290,train_flag=False)   
        
    elif dataset == 'U':
        train_dataset = load_USPS_LS_DRANet(target_num=180,train_flag=True)
        test_dataset = load_USPS_LS_DRANet(target_num=180,train_flag=True)
        
    elif dataset == 'MM':
        train_dataset = load_mnistm_LS_DRANet(target_num=1800,MNISTM=MNISTM_DRANet,train_flag=True)    
        test_dataset = load_mnistm_LS_DRANet(target_num=290,MNISTM=MNISTM_DRANet,train_flag=False)  
