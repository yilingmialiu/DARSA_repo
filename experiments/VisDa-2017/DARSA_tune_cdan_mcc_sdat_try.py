...
def train(batch_size, lr, K, lamb_clf, lamb_wd, lamb_centroid, lamb_sntg, epochs, LAMBDA, momentum, alpha, source_num, target_num, eval_target_num, lr_gamma=0.001, lr_decay=0.75):
    ...
    # Load the checkpoint
    checkpoint_path = '/home/yilingliu/ELS/Domain_Adaptation/logs/cdan_mcc_sdat_vit/VisDA2017/checkpoints/best.pth'
    ...
    for epoch in range(1, epochs+1):
        ...
        if True:  # Change to False for full training
            num_iterations = min(num_iterations, 50)  # Only run 5 iterations per epoch
...
if __name__ == '__main__':
    ...
    lamb_clf = 1.0
    lamb_wd = 1.0      # Increase from 0.5
    lamb_centroid = 1.0  # Increase from 0.3
    lamb_sntg = 0.001     # Increase from 0.3
    LAMBDA = 30
    momentum = 0.9
    alpha = 8
