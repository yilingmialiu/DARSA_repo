...
class OfficeHome(ImageList):
    ...
    image_list = {
        ...
        "Ar_s": "image_list/Art_s.txt",
        "Ar_t": "image_list/Art_t.txt",
        "Cl_s": "image_list/Clipart_s.txt",
        "Cl_t": "image_list/Clipart_t.txt",
        "Pr_s": "image_list/Product_s.txt",
        "Pr_t": "image_list/Product_t.txt",
        "Pr_te": "image_list/Product_t_extreme.txt",
        "Rw_s": "image_list/Real_World_s.txt",
        "Rw_se": "image_list/Real_World_s_extreme.txt",
        "Rw_t": "image_list/Real_World_t.txt",    
    }
